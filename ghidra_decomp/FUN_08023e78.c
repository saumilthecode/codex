...
undefined4 *
FUN_08023e78(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_08023f8a:
        ...
        while (local_68 = param_3, local_64 = param_4, uVar9 = FUN_08012ee0(&local_68,&param_5),
          ...
          if (iVar12 == iVar6) goto LAB_08023fdc;
          cVar3 = FUN_08012e9c(&local_68);
          param_3 = local_68;
          if (*(char *)(*(int *)(iVar8 + 0x14) + iVar12) != cVar3) goto LAB_08023fc6;
          FUN_08021b24(local_68);
          iVar12 = iVar12 + 1;
          param_4 = 0xffffffff;
        }
        if (iVar12 == iVar6) goto switchD_08023f04_default;
LAB_08023fc6:
        param_3 = local_68;
        param_4 = local_64;
        if (iVar12 == 0) {
      ...
      if (iVar10 == 1) {
        ...
        if (local_5c._3_1_ == '\x04') goto LAB_08023f8a;
        if (local_84 != 0) {
          if (local_5c._3_1_ == '\x03') goto LAB_08023f8a;
          iVar10 = 3;
          uVar9 = local_84;
          goto LAB_080241a8;
        }
      ...
      while (local_68 = param_3, local_64 = param_4, uVar9 = FUN_08012ee0(&local_68,&param_5),
        ...
        if (iVar6 == 0) {
          if ((*(char *)(iVar8 + 0x11) == cVar3) && (local_90 == 0)) {
            if (*(int *)(iVar8 + 0x2c) < 1) goto LAB_08023f34;
            local_88 = uVar11;
            uVar11 = 0;
            local_90 = uVar9;
          }
            ...
            if ((*(byte *)(iVar8 + 0x10) == 0) ||
               ((uVar9 = (uint)*(byte *)(iVar8 + 0x10), *(char *)(iVar8 + 0x12) != cVar3 ||
                (uVar9 = local_90, local_90 != 0)))) goto LAB_08023f34;
            if (uVar11 == 0) {
              uVar9 = 0;
              goto LAB_08023f34;
            }
...
LAB_08023ffe:
  ...
  param_3 = local_68;
  param_4 = local_64;
  if (iVar10 == 0) goto LAB_08024220;
  if (uVar9 == local_8c) goto LAB_08024224;
  cVar3 = FUN_08012e9c(&local_68);
  param_3 = local_68;
  param_4 = local_64;
  if (*(char *)(iVar5 + uVar9) != cVar3) goto LAB_080241ae;
  FUN_08021b24(local_68);
  uVar9 = uVar9 + 1;
  param_4 = 0xffffffff;
  goto LAB_08023ffe;
