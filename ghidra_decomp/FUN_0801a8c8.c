...
undefined4 *
FUN_0801a8c8(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
        ...
        do {
          if (uVar18 < puVar15[uVar10]) {
            ...
            if ((iVar4 == local_58[3]) ||
               ...
               uVar10 = local_58[0], iVar4 == local_58[2])) goto LAB_0801a9d6;
          }
          uVar10 = uVar10 + 1;
        } while (uVar14 != uVar10);
        local_38 = 0;
...
LAB_0801a9d6:
      ...
      if (uVar14 == 2) {
        if ((int)(param_9 << 0x1f) < 0) goto LAB_0801ab32;
        uVar14 = *puVar7;
        if (uVar14 < param_9 >> 1) {
          if (uVar14 + (param_9 >> 1) == local_58[uVar11 * -2 + 1]) goto LAB_0801aafe;
          goto LAB_0801ab32;
        }
        uVar14 = uVar14 - (param_9 >> 1);
        if (uVar14 != local_58[uVar11 * -2 + 1]) goto LAB_0801ab32;
        *puVar7 = uVar14;
        *(uint *)(uVar2 + uVar3 * 8) = puVar15[1];
        ...
        bVar1 = true;
LAB_0801aa36:
        if (uVar14 != 1) goto LAB_0801ab32;
        uVar18 = uVar17;
        if (!bVar1) goto LAB_0801aa3e;
      }
      goto LAB_0801aafe;
    }
    uVar13 = 0xffffffff;
...
LAB_0801aafe:
    ...
    for (; uVar18 < uVar14; uVar18 = uVar18 + 1) {
      ...
      if (iVar4 != iVar5) {
        ...
        if (iVar4 != iVar5) goto LAB_0801ab32;
      }
      FUN_080187b2(uVar12);
      uVar13 = 0xffffffff;
      puVar16 = puVar16 + 1;
