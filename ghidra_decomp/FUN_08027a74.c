...
uint FUN_08027a74(int param_1,uint param_2,int *param_3,uint *param_4)

{
  ...
  for (; iVar16 = *param_3, iVar16 != 0; param_3 = param_3 + 1) {
    ...
    if (*param_3 - 0x31U < 9) {
      uVar5 = FUN_08029b04(param_3,local_4a8,10);
      param_3 = local_4a8[0];
    }
    else {
      uVar5 = 0;
    ...
    case 0x44:
      ...
      goto LAB_08027d98;
    case 0x46:
      local_4a8[0] = (int *)0x25;
      ppiVar8 = local_4a8 + 2;
      if (piVar24 == (int *)0x0) {
        local_4a8[1] = (int *)0x2b;
        iVar16 = 4;
      }
      else {
        uVar11 = DAT_08027ec8;
    ...
    case 0x70:
      iVar16 = FUN_08027a54(auStack_428,
                            *(undefined4 *)(DAT_080281e8 + (uint)(0xb < (int)param_4[2]) * 4 + 0xa4)
                            ,&local_4ac);
      for (uVar5 = 0; uVar13 = uVar23, uVar5 < local_4ac; uVar5 = uVar5 + 1) {
        if (param_2 - 1 <= uVar23) {
          return 0;
        }
...
LAB_0802841e:
    ...
    case 0x62:
    case 0x68:
      iVar16 = FUN_08027a54(auStack_428,*(undefined4 *)(DAT_08027ea0 + param_4[4] * 4),&local_4ac);
      puVar6 = (undefined4 *)(iVar16 + -4);
      uVar13 = uVar23 + local_4ac;
...
LAB_080284a0:
    ...
    case 0x75:
      ...
      goto LAB_0802805e;
    case 0x76:
      FUN_0802ad80(local_4a8,DAT_080284ac);
      iVar16 = FUN_0802698c(local_4a8);
      ppiVar8 = local_4a8 + iVar16 + 1;
      if (piVar24 == (int *)0x0) {
        local_4a8[iVar16] = (int *)0x2b;
        iVar16 = 4;
      }
      else {
        local_4a8[iVar16] = piVar24;
        uVar11 = DAT_080284b0;
        if ((uVar5 < 6) || (iVar16 = uVar5 - 6, iVar16 == 0)) goto LAB_08027df0;
      }
...
LAB_08027ca4:
      ppiVar7 = (int **)FUN_08027a54(auStack_428,uVar11,&local_4ac);
      if (*ppiVar7 != (int *)0x0) {
LAB_08027cb6:
