...
undefined4 *
FUN_08014eec(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_0801507c:
          ...
          if (uVar14 != 10) goto LAB_08015084;
          if (uVar9 != 0) {
LAB_0801507a:
            uVar11 = uVar11 + 1;
            goto LAB_0801507c;
  ...
  if (uVar6 == 0) {
    ...
    while( true ) {
      ...
      if ((uVar7 == 0) || (*(char *)(iVar2 + 0x25) != cVar1)) {
        if (*(char *)(iVar2 + 0x24) == cVar1) goto LAB_08015218;
