...
undefined4 *
FUN_0800f2fc(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  FUN_0800e10a(&local_40,param_2,local_38,local_34,param_5,param_6,&local_30,0,99,2,iVar5,local_2c);
  local_38 = local_40;
  local_34 = uStack_3c;
  if (local_2c[0] != 0) {
    *puVar1 = *puVar1 | 4;
...
LAB_0800f41c:
    ...
    local_40 = uVar2;
    uStack_3c = uVar3;
    if (9 < (iVar5 - 0x30U & 0xff)) goto LAB_0800f41c;
    FUN_0800d316(uVar2);
