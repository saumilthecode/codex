...
undefined4 *
FUN_08012f90(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
        ...
        do {
          if (uVar13 < puVar16[uVar9]) {
            ...
            if ((iVar4 == auStack_58[4]) ||
               ...
               uVar9 = auStack_58[1], iVar4 == auStack_58[3])) goto LAB_08013096;
          }
          uVar9 = uVar9 + 1;
        } while (uVar15 != uVar9);
        local_38 = 0;
...
LAB_08013096:
      ...
      if (uVar15 == 2) {
        if ((int)(param_9 << 0x1f) < 0) goto LAB_080131e8;
        uVar15 = *puVar6;
        if (uVar15 < param_9 >> 1) {
          if (uVar15 + (param_9 >> 1) == auStack_58[uVar10 * -2 + 1]) goto LAB_080131b4;
          goto LAB_080131e8;
        }
        uVar15 = uVar15 - (param_9 >> 1);
        if (uVar15 != auStack_58[uVar10 * -2 + 1]) goto LAB_080131e8;
        *puVar6 = uVar15;
        *(uint *)(iVar4 + uVar2 * 8) = puVar16[1];
        ...
        bVar1 = true;
LAB_080130f6:
        if (uVar15 != 1) goto LAB_080131e8;
        uVar13 = uVar12;
        if (!bVar1) goto LAB_080130fe;
      }
      goto LAB_080131b4;
    }
    uVar14 = 0xffffffff;
...
LAB_080131b4:
    ...
    for (; uVar13 < uVar15; uVar13 = uVar13 + 1) {
      ...
      if (iVar4 != iVar5) {
        ...
        if (iVar4 != iVar5) goto LAB_080131e8;
      }
      FUN_08010bc6(uVar11);
      uVar14 = 0xffffffff;
      puVar17 = puVar17 + 1;
