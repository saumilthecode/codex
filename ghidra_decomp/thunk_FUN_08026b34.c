...
uint thunk_FUN_08026b34(int param_1,uint param_2,byte *param_3,uint *param_4)

{
  ...
  for (; bVar15 = *param_3, bVar15 != 0; param_3 = param_3 + 1) {
    ...
    if (*param_3 - 0x31 < 9) {
      uVar6 = FUN_08029a04(param_3,auStack_48);
      param_3 = _auStack_48;
    }
    else {
      uVar6 = 0;
    ...
    case 0x44:
      ...
      goto LAB_08026e2e;
    case 0x46:
      iVar7 = (int)auStack_48 + 2;
      if (bVar15 == 0) {
        _auStack_48 = (byte *)CONCAT22(auStack_46._0_2_,0x2b25);
        iVar8 = 4;
LAB_08026e90:
        ...
        auStack_48 = (undefined1  [2])CONCAT11(bVar15,0x25);
    ...
    case 0x47:
      ...
      if (bVar34) {
        uVar9 = 0x2d;
LAB_08026fda:
        _auStack_48 = (byte *)CONCAT31(stack0xffffffb9,uVar9);
        puVar11 = (undefined4 *)((int)auStack_48 + 1);
        iVar7 = 1;
      }
      else {
...
LAB_080272be:
    ...
    case 0x59:
      ...
      if ((int)uVar12 < DAT_08027530) {
        _auStack_48 = (byte *)CONCAT31(stack0xffffffb9,0x2d);
...
LAB_080273e4:
        ...
        uVar12 = uVar12 + 0x76c;
        if ((bVar15 == 0x2b) && (9999 < uVar12)) {
          _auStack_48 = (byte *)CONCAT31(stack0xffffffb9,0x2b);
          goto LAB_080273e4;
        }
        iVar7 = 0;
        puVar11 = (undefined4 *)auStack_48;
