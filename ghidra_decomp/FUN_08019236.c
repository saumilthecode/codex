...
int FUN_08019236(undefined4 *param_1,undefined4 param_2,uint param_3,uint param_4,int param_5,
...

{
  ...
  if (param_7 == '\0') {
    if ((param_6 & 0x4a) == 0x40) {
      do {
        puVar4 = puVar4 + -1;
        *puVar4 = *(undefined4 *)(param_5 + ((param_3 & 7) + 4) * 4);
      ...
      do {
        puVar4 = puVar4 + -1;
        *puVar4 = *(undefined4 *)(param_5 + ((param_3 & 0xf) + iVar1) * 4);
    ...
    do {
      ...
      puVar4 = puVar4 + -1;
      *puVar4 = *(undefined4 *)(param_5 + (iVar1 + 4) * 4);
    } while (uVar3 != 0 || uVar3 < (9 < uVar2));
  }
  return (int)param_1 - (int)puVar4 >> 2;
}
