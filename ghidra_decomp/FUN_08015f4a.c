...
undefined4 *
FUN_08015f4a(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  FUN_08012eee(&local_40,param_2,local_38,local_34,param_5,param_6,&local_30,0,99,2,iVar6,local_2c);
  local_38 = local_40;
  local_34 = uStack_3c;
  if (local_2c[0] != 0) {
    *puVar1 = *puVar1 | 4;
...
LAB_0801606a:
    ...
    local_40 = uVar2;
    uStack_3c = uVar3;
    if (9 < (iVar6 - 0x30U & 0xff)) goto LAB_0801606a;
    FUN_08010bc6(uVar2);
