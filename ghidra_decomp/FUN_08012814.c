...
undefined4 *
FUN_08012814(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  iVar3 = FUN_080119dc(param_5 + 0x6c);
  pbVar9 = (byte *)*param_7;
...
LAB_08012a2a:
    ...
    if (uVar13 < uVar12) {
      if (uVar14 == 0x20) {
        ...
        uVar5 = FUN_08010c20(iVar2,0,DAT_08012a78);
