...
undefined4 *
FUN_080195e8(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  iVar3 = FUN_0801956c(param_5 + 0x6c);
  piVar8 = (int *)*param_7;
...
LAB_080197ea:
    ...
    if (uVar12 < uVar10) {
      if (uVar14 == 0x20) {
        ...
        uVar5 = FUN_080187cc(iVar3,0,DAT_08019838);
