...
undefined4 *
FUN_0801c82c(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_0801c9b2:
          ...
          if (uVar14 != 10) goto LAB_0801c9ba;
          if (uVar9 != 0) {
LAB_0801c9b0:
            uVar11 = uVar11 + 1;
            goto LAB_0801c9b2;
  ...
  if (uVar6 == 0) {
    ...
    while( true ) {
      ...
      if ((uVar7 == 0) || (*(int *)(iVar1 + 0x28) != iVar3)) {
        if (*(int *)(iVar1 + 0x24) == iVar3) goto LAB_0801cb56;
        uVar7 = FUN_08018960(iVar1 + 0xcc,local_4c);
        if (uVar7 == 0) goto LAB_0801caa0;
