...
undefined4
FUN_08012262(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_38 = param_3;
  uStack_34 = param_4;
  uVar9 = FUN_0801139c(param_5 + 0x6c);
  iVar3 = (int)uVar9;
  uVar5 = *(uint *)(param_5 + 0xc);
  uVar6 = uVar5 & 0x4a;
  piVar7 = local_80;
  local_80[2] = (int)(uVar6 != 0x40 && uVar6 != 8);
  local_80[0] = iVar3 + 0x26;
  local_80[1] = uVar5;
  local_48 = local_80[2];
  local_2c[0] = FUN_080116cc(&local_48,(int)((ulonglong)uVar9 >> 0x20),local_40,local_44);
  puVar4 = (undefined1 *)((int)&local_48 - local_2c[0]);
  if (*(char *)(iVar3 + 0x10) != '\0') {
    iVar2 = -(local_2c[0] * 2 + 9U & 0xfffffff8);
    piVar7 = (int *)((int)local_80 + iVar2);
  ...
  if (((local_48 == 0) && ((int)(uVar5 << 0x16) < 0)) && (local_40 != 0 || local_44 != 0)) {
    if (uVar6 == 0x40) {
  ...
  if (local_2c[0] < iVar3) {
    ...
    piVar8 = (int *)((int)piVar7 + iVar2);
    *(undefined1 **)((int)piVar7 + iVar2 + 4) = puVar4;
    *(int **)((int)piVar7 + iVar2 + 8) = local_2c;
    puVar4 = (undefined1 *)((int)piVar7 + iVar2 + 0x10);
    *(undefined1 **)((int)piVar7 + iVar2) = puVar4;
