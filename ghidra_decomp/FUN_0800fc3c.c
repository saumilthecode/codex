...
undefined4 *
FUN_0800fc3c(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_0800fd4e:
        ...
        while (local_68 = param_3, local_64 = param_4, uVar9 = FUN_0800e0fc(&local_68,&param_5),
          ...
          if (iVar6 == iVar5) goto LAB_0800fd9e;
          iVar4 = FUN_0800e0b8(&local_68);
          param_3 = local_68;
          if (*(int *)(*(int *)(iVar8 + 0x1c) + iVar6 * 4) != iVar4) goto LAB_0800fd88;
          FUN_0800d316(local_68);
          iVar6 = iVar6 + 1;
          param_4 = 0xffffffff;
        }
        if (iVar6 == iVar5) goto switchD_0800fcc8_default;
LAB_0800fd88:
        param_3 = local_68;
        param_4 = local_64;
        if (iVar6 == 0) {
      ...
      if (iVar10 == 1) {
        ...
        if (local_5c._3_1_ == '\x04') goto LAB_0800fd4e;
        if (local_84 != 0) {
          if (local_5c._3_1_ == '\x03') goto LAB_0800fd4e;
          iVar10 = 3;
          uVar9 = local_84;
          goto LAB_0800ff66;
        }
      ...
      while (local_68 = param_3, local_64 = param_4, uVar9 = FUN_0800e0fc(&local_68,&param_5),
        ...
        if (iVar6 == 0) {
          if ((*(int *)(iVar8 + 0x14) == iVar5) && (local_90 == 0)) {
            if (*(int *)(iVar8 + 0x34) < 1) goto LAB_0800fcf8;
            local_88 = uVar11;
            uVar11 = 0;
            local_90 = uVar9;
          }
            ...
            if ((*(byte *)(iVar8 + 0x10) == 0) ||
               ((uVar9 = (uint)*(byte *)(iVar8 + 0x10), *(int *)(iVar8 + 0x18) != iVar5 ||
                (uVar9 = local_90, local_90 != 0)))) goto LAB_0800fcf8;
            if (uVar11 == 0) {
              uVar9 = 0;
              goto LAB_0800fcf8;
            }
...
LAB_0800fdc0:
  ...
  param_3 = local_68;
  param_4 = local_64;
  if (iVar5 == 0) goto LAB_0800ffe4;
  if (uVar9 == local_8c) goto LAB_0800ffe8;
  iVar5 = FUN_0800e0b8(&local_68);
  param_3 = local_68;
  param_4 = local_64;
  if (*(int *)(iVar10 + uVar9 * 4) != iVar5) goto LAB_0800ff6c;
  FUN_0800d316(local_68);
  uVar9 = uVar9 + 1;
  param_4 = 0xffffffff;
  goto LAB_0800fdc0;
